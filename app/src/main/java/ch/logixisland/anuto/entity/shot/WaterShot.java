...
public class WaterShot extends Shot implements SpriteTransformation, TargetTracker.Listener {

    private final static float MOVEMENT_SPEED = 4.0f;
    private final static float ROTATION_SPEED = 1.5f;
    ...
    public WaterShot(Entity origin, Vector2 position, Enemy target, float damage) {
        super(origin);
    ...
    public Object initStatic() {
        ...
        s.mSpriteTemplate = getSpriteFactory().createTemplate(R.attr.waterShot, 4);
        s.mSpriteTemplate.setMatrix(0.3f, 0.3f, null, null);
